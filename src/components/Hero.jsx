    ...
    <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 pt-20">
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-8 relative inline-block">
          <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full overflow-hidden border-2 border-primary/30 mx-auto ring-4 ring-primary/10">
            <img
              src={profileImg}
              alt="José Mora"
        ...
        <p className="text-primary font-mono text-xs sm:text-sm mb-4 tracking-wider">{t.hero.greeting}</p>
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-text-primary to-text-secondary bg-clip-text text-transparent">
          {t.hero.name}
        </h1>
        <h2 className="text-lg sm:text-xl md:text-2xl text-text-secondary mb-6 sm:mb-8">
          {t.hero.title}
        </h2>
        <p className="text-sm sm:text-base text-text-muted max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2">
          {t.hero.subtitle}
        </p>

        <div className="flex justify-center gap-2 sm:gap-4 flex-wrap">
          <a
            href="https://github.com/moramjose"
            target="_blank"
            rel="noopener noreferrer"
            data-umami-event="hero-github"
            className="flex items-center gap-1.5 sm:gap-2 px-3.5 sm:px-5 py-2 sm:py-2.5 rounded-lg bg-bg-card border border-border hover:border-primary/50 text-text-secondary hover:text-primary transition-all text-sm sm:text-base"
          >
          ...
          <a
            href="https://linkedin.com/in/devmoramjose"
            target="_blank"
            rel="noopener noreferrer"
