      ...
      <div className="max-w-2xl mx-auto">
        ...
        <AnimateIn delay={0.3}>
          <div className="flex justify-center gap-6">
            ...
            <a href="https://wa.me/17865693237" target="_blank" rel="noopener noreferrer" data-umami-event="contact-whatsapp" className="text-text-muted hover:text-primary transition-colors" aria-label="WhatsApp">
